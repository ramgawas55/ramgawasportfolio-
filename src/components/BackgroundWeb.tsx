...
export default function BackgroundWeb() {
  ...
  return (
    <div className="pointer-events-none fixed inset-0 -z-10 overflow-hidden">
      ...
      <motion.div
        style={{ opacity: glow }}
        className="absolute -left-48 top-24 h-72 w-72 rounded-full bg-[#ff3b30]/20 blur-3xl"
      />
      <motion.div
        style={{ opacity: glow }}
        className="absolute right-0 top-1/2 h-96 w-96 -translate-y-1/2 rounded-full bg-[#ff4d22]/20 blur-3xl"
      />
    </div>
  );
}
