...
export default function ContactPage() {
  ...
  const handleSubmit = async (event: FormEvent) => {
    ...
    try {
      ...
      const visitorEmail = typeof window !== "undefined" ? localStorage.getItem("visitor_email") || "unknown" : "unknown";
      fetch("/api/track", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify({ event: "contact_submit", path: "/contact", email: visitorEmail }),
      }).catch(() => { });
